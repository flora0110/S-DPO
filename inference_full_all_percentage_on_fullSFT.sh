...
do      
        CUDA_VISIBLE_DEVICES=$gpu1 python inference.py \
                ...
                --resume_from_checkpoint ./output/${reject_sort_metric}_${reject_select_mode}_lastfm_dpo_321B_200seq_1epoch_on_full_sft \
                >  ./output/${reject_sort_metric}_${reject_select_mode}_lastfm_dpo_321B_200seq_1epoch_on_full_sft/eval.log
done