...
for reject_select_mode in "random"
do

    logging_dir=./logs/sdpo_neg3/${reject_select_mode}_lastfm_321B_200seq_${num_train_epochs}epoch/
    output_dir=./output/sdpo_neg3/${reject_select_mode}_lastfm_321B_200seq_${num_train_epochs}epoch/
    ...
    {
        CUDA_VISIBLE_DEVICES=$gpu1 python softmax_dpo2.py \
