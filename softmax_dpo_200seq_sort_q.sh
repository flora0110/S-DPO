...
do
    logging_dir=./logs/sdpo_neg3/${reject_sort_metric}_${reject_select_mode}_p${center_q}_sigma${sigma_ratio}_lastfm_321B_200seq_${num_train_epochs}epoch/
    output_dir=./output/sdpo_neg3/${reject_sort_metric}_${reject_select_mode}_p${center_q}_sigma${sigma_ratio}_lastfm_321B_200seq_${num_train_epochs}epoch/
