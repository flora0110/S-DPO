...
train_candidate_score_path=./toy_200seq/train_candidate_scores_w_hidden_on_full_sft.jsonl
val_candidate_score_path=./toy_200seq/val_candidate_scores_w_hidden_on_full_sft.jsonl
batch_size=4
...
do
    ...
    logging_dir=./logs//${reject_sort_metric}_${reject_select_mode}_lastfm_dpo_321B_200seq_1epoch_on_full_sft/
    output_dir=./output/${reject_sort_metric}_${reject_select_mode}_lastfm_dpo_321B_200seq_1epoch_on_full_sft/
