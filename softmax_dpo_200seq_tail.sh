...
sigma_ratio=0.25
reject_select_mode="tail_random"
temperature=0.25

for temperature in 0.25 0.15
do
    logging_dir=./logs/sdpo_neg3/${reject_sort_metric}_${reject_select_mode}_t${temperature}_lastfm_321B_200seq_${num_train_epochs}epoch/
    output_dir=./output/sdpo_neg3/${reject_sort_metric}_${reject_select_mode}_t${temperature}_lastfm_321B_200seq_${num_train_epochs}epoch/
