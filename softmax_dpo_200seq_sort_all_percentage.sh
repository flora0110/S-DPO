...
do
    ...
    [ "$reject_select_mode" == "bell_q75_random" ]; then
        logging_dir=./logs/sdpo_neg3/${reject_sort_metric}_${reject_select_mode}_sigma${sigma_ratio}_lastfm_321B_200seq_${num_train_epochs}epoch/
        output_dir=./output/sdpo_neg3/${reject_sort_metric}_${reject_select_mode}_sigma${sigma_ratio}_lastfm_321B_200seq_${num_train_epochs}epoch/
    else
        # echo "ERROR"
